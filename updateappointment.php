        ...
        if (move_uploaded_file($pdfFile['tmp_name'], $pdfFilePath)) {
            ...
            if ($stmt->execute()) {
                ...
                try {
                    ...
                    $mail->Password = 'jrqt hbaq mkrt tbjq';  // Replace with a secure method for storing passwords
                    ...
                    $mail->Body = "<div style='font-family: Arial, sans-serif; color: #333;'>
                                      ...
                                      <p>Thank you for choosing Petsvibe!🐾🐾🐾</p>
                                    </div>";
        ...
        if ($stmt->execute()) {
            ...
            try {
                ...
                $mail->Body = "<div style='font-family: Arial, sans-serif; color: #333;'>
                                  ...
                                  <p>Thank you for your understanding. If you have any questions, please feel free to reach out.</p>
                                  <p>Thank you for choosing Petsvibe!</p>
                               </div>";
